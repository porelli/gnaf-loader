--DROP TABLE IF EXISTS gnaf_202602.temp_address_principals;
--CREATE TABLE gnaf_202602.temp_address_principals AS
...
--FROM gnaf_202602.address_principals;
--
--ALTER TABLE ONLY gnaf_202602.temp_address_principals
