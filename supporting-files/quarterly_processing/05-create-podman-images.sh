...
echo "---------------------------------------------------------------------------------------------------------------------"
echo "push '202511' GDA94 images : $(date)"
echo "---------------------------------------------------------------------------------------------------------------------"

podman manifest push --compression-level 9 localhost/gnafloader docker://docker.io/minus34/gnafloader:202511
...
echo "---------------------------------------------------------------------------------------------------------------------"
echo "push '202511' GDA2020 images : $(date)"
echo "---------------------------------------------------------------------------------------------------------------------"

podman manifest push --compression-level 9 localhost/gnafloader-gda2020 docker://docker.io/minus34/gnafloader:202511-gda2020
