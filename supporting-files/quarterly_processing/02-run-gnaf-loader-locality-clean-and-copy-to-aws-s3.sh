...
GNAF_PATH="/Users/$(whoami)/Downloads/g-naf_nov25_allstates_gda94_psv_1021"
BDYS_PATH="/Users/$(whoami)/Downloads/NOV25_AdminBounds_GDA_94_SHP"
...
aws --profile=${AWS_PROFILE} s3 sync ${OUTPUT_FOLDER} s3://minus34.com/opendata/geoscape-202511 --exclude "*" --include "*.zip" --acl public-read
...
/Applications/Postgres.app/Contents/Versions/14/bin/pg_dump -Fc -d geo -n gnaf_202511 -p 5432 -U postgres -f "${OUTPUT_FOLDER}/gnaf-202511.dmp" --no-owner
echo "GNAF schema exported to dump file"
/Applications/Postgres.app/Contents/Versions/14/bin/pg_dump -Fc -d geo -n admin_bdys_202511 -p 5432 -U postgres -f "${OUTPUT_FOLDER}/admin-bdys-202511.dmp" --no-owner
...
aws --profile=${AWS_PROFILE} s3 sync ${OUTPUT_FOLDER} s3://minus34.com/opendata/geoscape-202511 --exclude "*" --include "*.dmp" --acl public-read
